...
import NewRelatedTo from './NewRelatedTo';
          ...
          <nav className="bread" aria-label="breadcrumb">
            {
              items.map((value,key) => {
                if(key === parseInt(this.props.match.params.id)){
                  return (
                    <ol className="breadcrumb" key>
                      <li className="breadcrumb-item"><a href="/">Home</a></li>
                      <li className="breadcrumb-item"><a href="/">Độc lạ</a></li>
                ...
                items.map((value,key) => {
                  if(key !== parseInt(this.props.match.params.id)){
                    if(dem<= 6){
                      dem++;
                      return (
                        <NewRelatedTo key={key} Id={key} Image={value.img} Name={value.name}/>
                      )
                    }
                  }
                  else{
...
export default connect(mapStateToProps, {getDataItem})(Detail);